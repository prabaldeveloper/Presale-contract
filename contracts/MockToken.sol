...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
     ...
     * construction.
     */
    function __ERC20_init(string memory name_, string memory symbol_, uint8 decimal_) internal onlyInitializing {
        __ERC20_init_unchained(name_, symbol_, decimal_);
    }

    function __ERC20_init_unchained(string memory name_, string memory symbol_, uint8 decimal_) internal onlyInitializing {
        _name = name_;
        _symbol = symbol_;
        _decimal = decimal_;
    }
...
contract MockToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    /// @param treasury The address to receive the initial supply of tokens.
    function initialize(string memory name, string memory symbol, uint8 decimal, uint256 initialSupply, address treasury) public initializer {
        __Ownable_init();
        __ERC20_init(name, symbol, decimal);
